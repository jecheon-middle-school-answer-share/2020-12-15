...
## 조회
### 바로가기
[조회 바로가기](https://rang.edunet.net/class/G000364114/classNotifyView.do?pageNo=1&notifySequence=303541)

## 1교시 - 기가
### 바로가기
[기가 바로가기](https://rang.edunet.net/class/G000367106/hmwkppList.do?hmwkSeq=734952&hmwkTypeCd=ALL)
### 문제
```
해상 수송과 항공 수송 중 중력에 반하여 작용하는 힘을 각 각 쓰시오.
```
### 정답
부력, 양력
### 참고 자료
[![Youtube](http://img.youtube.com/vi/0lsXXPLSMt4/0.jpg)](https://www.youtube.com/embed/0lsXXPLSMt4 "Youtube")
...
```
### 정답
1. 12개의 스택스 컵을 쌓고 내리는 것
2. 1. 눈과 손의 협응력, 집중력, 순발력 향상.
   2. 자신감, 팀워크, 스포츠맨십 햠양.
   3. 장소나 시간에 상관없이 언제 어디서나 수행할 수 있다.
3. 1. 오른손과 왼손 / 왼손과 오른손을 번갈아 가며 사용
   2. 업스태킹으로 시작 -> 다운스태킹으로 마무리
   3. 업스태킹의 방향과 다운스태킹의 방향은 같아야 한다.
   4. 다음과 같은 상황에서 무너진 컵은 무너진 부분에서 다시 시작한다.
### 참고 자료
...
### 문제
```
지난 시간에 작성했던 영어 표현 이외에 영어 줄임말을 검색하여 5개를 적어봅시다.
```
### 정답
아래에서 5개만 골라쓰기

- lol, laugh out loud, 웃기다
- lmao, laughing my ass off, 미친듯이 웃기다
- lmfao, laughing my fucking ass off, 미친듯이 웃기다
- rofl, rolling on the floor laughing, 미친듯이 웃기다
- omg, oh my god, 오마이갓
- g2g(gtg), got to go, 가봐야겠다
- ttyl, talk to you later, 나중에 얘기하자!
- gr8, great, great
- omw, on my way, 가는 중!
- wtf, what the fuck, 아 뭐야?
- fml, fuck my life, 아 짜증나.
- dm, direct message, 다이렉트 메세지
- jw, just wondering, 그냥 궁금해서.
- k, okay, okay
- yolo, you only live one, 인생은 한 번뿐
- bae, baby, 자기
- <3, heart, 하트
- sry, sorry, 미안해
- thx, thanks, 고마워
...
- gn, good night, 좋은 밤
- idk, I don't know, 몰라
- idc, I don't care, 상관없어
- rn, right now, 당장
- imy, I miss you, 너가 그리워
- ily, I love you, 너를 좋아해
- b/c, because, 왜냐하면
- b/w, between, 사이에
### 참고 자료
[![Youtube](http://img.youtube.com/vi/dvXSTh22uJk/0.jpg)](https://www.youtube.com/embed/dvXSTh22uJk "Youtube")
